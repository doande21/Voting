            ...
            <div className="flex items-center gap-4">
              {user ? (
                ...
                <button 
                  ...
                  className="bg-orange-500 text-white px-6 py-2 rounded-full text-sm font-bold hover:bg-orange-600 transition-all flex items-center gap-2 shadow-md shadow-orange-100"
                >
